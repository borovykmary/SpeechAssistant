...
urlpatterns = [
    ...
    path('results/user/<int:user_id>/', views.get_results_by_user, name='get_results_by_user'),
    path('results/<int:result_id>/', views.get_result_by_id, name='get_result_by_id'),
